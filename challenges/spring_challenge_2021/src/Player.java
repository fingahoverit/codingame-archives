...
class Action {
    ...
    final String type;
    final Integer targetCellIdx;
    final Integer sourceCellIdx;
...
class Game {
    ...
    final List<Action> possibleActions;
    ...
    Action getNextAction() {
        ...
        return (possibleActions.size() > 1)?possibleActions.get(1):possibleActions.get(0);
    }
